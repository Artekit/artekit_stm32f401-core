...
public:
	...
	virtual inline void* getSamplesPtr()			{ return NULL; }
	...
	virtual inline bool stopped() 					{ return status == AudioSourceStopped; }
	...
	virtual void setVolume(float value, uint32_t samples);
